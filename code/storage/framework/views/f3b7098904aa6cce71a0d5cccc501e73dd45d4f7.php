			...
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="featured-tab color-orange">
						<h3 class="block-title"><span>TUYÊN TRUYỀN CỔ ĐỘNG VÀ TRIỂN LÃM</span></h3>
						<ul class="nav nav-tabs">
					...
					<div class="featured-tab color-dark-blue">
						<h3 class="block-title"><span>NGHỆ THUẬT QUẦN CHÚNG</span></h3>
						<ul class="nav nav-tabs">
						...
						<div class="widget color-default">
							...
							<div class="row">
								...
								<?php $__currentLoopData = json_decode($images->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>  $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="col-md-6" style="padding:0; padding-bottom: 5px">
										<a class="image-link" href="<?php echo e(Voyager::image($item)); ?>">
											<img  style="height: 100px;width: 100% ; object-fit: cover" src="<?php echo e(Voyager::image($item)); ?>" alt="" loading="lazy">
										</a>
