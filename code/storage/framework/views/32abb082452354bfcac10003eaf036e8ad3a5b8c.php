      ...
      <div class="row">
        <div class="col-lg-3 col-sm-12 footer-widget">
          ...
          <div class="list-post-block custom-footer ">
            <img src="<?php echo e(Voyager::image(setting('site.logo'))); ?>" alt="" loading="lazy" style="width: 200px">
...
<?php endif; ?>
<!-- END OF FOOTER --><?php /**PATH /home/tinhtoan/domains/tinhtoan.kennatech.vn/public_html/resources/views/frontend/layouts/partials/footer.blade.php ENDPATH**/ ?>